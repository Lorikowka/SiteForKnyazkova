...
const DIPLOMAS = [
  ...
  { img: 'images/diplomas/diploma_3.png', title: 'Диплом о профессиональной переподготовке — Институт прикладной психологии, психолог-тренер, 340 часов, 2025. Дает право на ведение деятельности в сфере практической психологии.' },
  ...
  { img: 'images/diploma_3/file-001.png', title: 'Диплом 3 — файл 1' },
...
function renderDiplomaPreviews() {
  ...
  // Фильтруем дипломы, чтобы в карусели были только "обложки" из папки /diplomas/
  const diplomaPreviews = DIPLOMAS.filter(d => d.img.startsWith('images/diplomas/'));

  diplomaPreviews.forEach((diploma) => {
    const originalIndex = DIPLOMAS.indexOf(diploma);
